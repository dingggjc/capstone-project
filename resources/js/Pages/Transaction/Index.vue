                                        ...
                                        <form @submit.prevent="submitCustomerForm"
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch"
                                                    ...
                                                    class="text-black mb-5 w-full bg-gray-200 hover:bg-grey-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 rounded-lg font-medium text-sm px-5 py-2 text-center inline-flex items-center justify-between dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
                                                    type="button">
                                                    Click me
